...
// let radius = parseInt(prompt("nhap ban kinh"))
// let dienTich = Math.PI * Math.pow(radius , 2)
// let chuVi = 2 * Math.PI * radius;
//
// console.log( "Chu vi hinh tron la: " + chuVi.toFixed(2));
// console.log( "Chu dien tich  tron la: " + dienTich.toFixed(2));
